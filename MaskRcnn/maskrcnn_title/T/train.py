...
def main():
    ...
    dataset = torch.utils.data.Subset(dataset, indices[0:110])
    print("========",len(indices[0:110]),indices[0:110])

    dataset_test = torch.utils.data.Subset(dataset_test, indices[110:122])
    print("========", len(indices[110:122]), indices[110:122])
    ...
    torch.save(model.state_dict(), "my_model_title.pth")
